...
with st.expander("Contingency Analysis", expanded=st.session_state.button):
    ...
    st.markdown('Contingency Analysis involves simulating faults on the network to determine which result in a constraint.')
    st.markdown('The _App_ executes double circuit contingencies outlined through Neptune')
